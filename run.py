#!/usr/bin/env python3
"""Run ONE problem of bbh through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one bbh problem via TrustedRouter")
