...
`eval-bbh` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/bbh`)
...
- `huggingface`: `Joschka/big_bench_hard`
- `huggingface`: `Joschka/big_bench_hard`
