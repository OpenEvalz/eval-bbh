...
Tests AI models on a suite of 23 challenging BIG-Bench tasks that previously proved difficult
even for advanced language models to solve.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/bbh`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/bbh) |
| Group | Reasoning |
| Total samples | 250 |
...
- `huggingface` — `Joschka/big_bench_hard` (pinned)
- `huggingface` — `Joschka/big_bench_hard` (pinned)
